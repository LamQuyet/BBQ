...
const AdminTab = ({ numberCart }: any) => {
    return (
        ...
        >
            <Tab.Screen name="Bills" component={Order} options={{ headerShown: false }} />
            <Tab.Screen name="Foods" component={FoodManage} options={{ headerShown: false }} />
            <Tab.Screen name="Accounts" component={AdmAccount} options={{ headerShown: false }} />
